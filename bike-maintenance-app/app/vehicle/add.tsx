  ...
  return (
    <SafeAreaView className="flex-1 bg-canvas-light dark:bg-canvas-dark">
      <ScrollView showsVerticalScrollIndicator={false} className="flex-1 px-7 pt-6">
        <Button variant="ghost" size="sm" onPress={() => router.back()} leftIcon={<ArrowLeft size={16} color="#6b6b80" />} className="mb-4 self-start" data-cy="add-vehicle-back">Back</Button>
        <Text className="text-text-primary dark:text-text-primary-dark text-3xl font-light tracking-tight mb-1">Add Vehicle</Text>
